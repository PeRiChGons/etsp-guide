  ...
  window.REFERENCE_DATA = {
    ...
    objectCatalog: {
      ...
      entries: [
        ...
        { name: 'Primordial Talisman', category: 'Talisman', source: 'Rage Boss: Verdure Shrine; Northen Abyss', status: 'observado', sourceVideo: 'Wisp.mp4', timestamp: '00:25', notes: 'Talisman observado en Wisp. El icono exacto queda pendiente de una captura limpia de la ficha; no se muestra una imagen dudosa en el buscador.' },
        { name: 'True Immortal Talisman', category: 'Talisman', source: 'Rage Boss: Verdure Shrine; Northen Abyss', status: 'observado', sourceVideo: 'Wisp.mp4', timestamp: '00:30', notes: 'Talisman observado en Wisp. El icono exacto queda pendiente de una captura limpia de la ficha; no se muestra una imagen dudosa en el buscador.' },
