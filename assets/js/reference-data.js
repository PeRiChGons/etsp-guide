...
(function () {
  ...
  window.REFERENCE_DATA = {
    ...
    objectCatalog: {
      ...
      categories: ['Talisman', 'Spirit', 'Spirit Root', 'Technique', 'Material', 'Gear', 'Trinket', 'Arraycore', 'Currency', 'Recompensa', 'Title', 'Outfit', 'Montura', 'Arma'],
      entries: [
        { id: '302131', name: 'Shenlong', category: 'Montura', modelKey: 'Shenlong', description: 'Montura Shenlong identificada en el modelo del cliente.' },
        { id: '302168', name: 'Feijian', category: 'Montura', modelKey: 'Feijian', description: 'Montura Feijian identificada en el modelo del cliente.' },
        { id: '302171', name: 'Bawanglong', category: 'Montura', modelKey: 'Bawanglong', description: 'Montura Bawanglong identificada en el modelo del cliente.' },
        { id: '302220', name: 'Fugu', category: 'Montura', modelKey: 'Fugu', description: 'Montura Fugu identificada en el modelo del cliente.' },
        { id: '210001', name: 'Shengshi Zijia', category: 'Outfit', modelKey: 'Shengshi Zijia', description: 'Pieza de vestimenta de cintura identificada en el modelo del cliente.' },
        { id: '210005', name: 'Shengdun', category: 'Outfit', modelKey: 'Shengdun', description: 'Pieza de vestimenta de cintura identificada en el modelo del cliente.' },
        { id: '1221033', name: 'Weapon 1221033', category: 'Arma', modelKey: 'Weapon 1221033', description: 'Modelo de arma extraído del cliente.' },
        { id: '123149', name: 'Weapon 123149', category: 'Arma', modelKey: 'Weapon 123149', description: 'Modelo de arma del cliente con variante femenina identificada en la malla.' },
        { id: '124140', name: 'Weapon 124140', category: 'Arma', modelKey: 'Weapon 124140', description: 'Modelo de arma del cliente.' },
        { id: '161101', name: 'Weapon 161101', category: 'Arma', modelKey: 'Weapon 161101', description: 'Modelo de arma del cliente.' },
