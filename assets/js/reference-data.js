  ...
  window.REFERENCE_DATA = {
    ...
    objectCatalog: {
      ...
      entries: [
        ...
        { name: 'Aura Crystalline', category: 'Material', source: 'Spirit Spring; Boss Store', status: 'confirmado', image: 'assets/images/items/aura-crystalline.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material visible para avanzar Techniques; su icono aparece en Boss Store.' },
        ...
        { name: 'Basic Cleansing Pill', category: 'Material', source: 'Cleanse', status: 'confirmado', image: 'assets/images/items/basic-cleansing-pill.jpg', sourceVideo: 'Cleanse.mp4', timestamp: '00:00', notes: 'Se consume durante los intentos de Cleanse.' },
        { name: 'Advanced Cleansing Pill', category: 'Material', source: 'Cleanse', status: 'confirmado', image: 'assets/images/items/advanced-cleansing-pill.jpg', sourceVideo: 'Cleanse.mp4', timestamp: '00:00', notes: 'Material mostrado en la interfaz de Cleanse.' },
        ...
        { name: 'Primordial Talisman', category: 'Talisman', source: 'Rage Boss: Verdure Shrine; Northen Abyss', status: 'confirmado', image: 'assets/images/items/primordial-talisman.jpg', sourceVideo: 'Wisp.mp4', timestamp: '00:25', notes: 'Primordial Talisman. Open for a chance to get up to a Gold Spirit. La ventana muestra Rage Boss y Event como métodos.' },
        { name: 'True Immortal Talisman', category: 'Talisman', source: 'Rage Boss: Verdure Shrine; Northen Abyss', status: 'confirmado', image: 'assets/images/items/true-immortal-talisman.jpg', sourceVideo: 'Wisp.mp4', timestamp: '00:30', notes: 'True Immortal Talisman. Open for a chance to get up to a Pink Spirit. La ventana muestra Rage Boss y Event como métodos.' },
        ...
        { name: 'Alioth Arraycore', category: 'Arraycore', source: 'Spirit Treasure', status: 'confirmado', image: 'assets/images/items/alioth-arraycore.jpg', sourceVideo: 'Spirit Treasure y lo que consigues.mp4', timestamp: '01:40', notes: 'Arraycore observado en T22 con HP 575 y DEF 72.' },
        { name: 'Mizar Arraycore', category: 'Arraycore', source: 'Spirit Treasure', status: 'confirmado', image: 'assets/images/items/mizar-arraycore.jpg', sourceVideo: 'Spirit Treasure y lo que consigues.mp4', timestamp: '01:40', notes: 'Arraycore observado en T22 con ATK 21 y S.A 72.' },
        { name: 'Alkaid Arraycore', category: 'Arraycore', source: 'Spirit Treasure', status: 'confirmado', image: 'assets/images/items/alkaid-arraycore.jpg', sourceVideo: 'Spirit Treasure y lo que consigues.mp4', timestamp: '01:40', notes: 'Arraycore observado en T14 con HP 2300 y DEF 288.' },
        ...
        { name: 'Golden Gear Stone', category: 'Material', source: 'Shop / Exchange', status: 'confirmado', image: 'assets/images/items/golden-gear-stone.jpg', detailImage: 'assets/images/object-details/golden-gear-stone.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material de equipo con icono propio visible en Boss Store.' },
        ...
        { name: 'Sky-Mending Stone', category: 'Material', source: 'Craft / equipo glossy', status: 'confirmado', image: 'assets/images/items/sky-mending-stone.jpg', sourceVideo: 'Craft.mp4', timestamp: '01:40', notes: 'Material de forja descrito como necesario para promocionar equipo a calidad glossy.' },
        { name: 'Immortal Gear Holyst', category: 'Material', source: 'Fuse', status: 'confirmado', image: 'assets/images/items/immortal-gear-holyst.jpg', sourceVideo: 'Craft.mp4', timestamp: '01:50', notes: 'Material obtenido al fusionar 8 Golden Gear Stones; puede desmontarse de nuevo en Golden Gear Stones.' },
        { name: 'Qiongqi Chestplate', category: 'Gear', source: 'Craft', status: 'confirmado', image: 'assets/images/items/qiongqi-chestplate.jpg', sourceVideo: 'Craft.mp4', timestamp: '00:10', notes: 'Pieza de equipo Qiongqi mostrada en la lista de Common Craft.' },
        ...
        { name: 'Qiongqi Spear', category: 'Gear', source: 'Craft', status: 'confirmado', image: 'assets/images/items/qiongqi-spear.jpg', sourceVideo: 'Craft.mp4', timestamp: '00:10', notes: 'Arma Qiongqi mostrada en la lista de Common Craft.' },
        { name: 'Qiongqi Bracers', category: 'Gear', source: 'Craft', status: 'confirmado', image: 'assets/images/items/qiongqi-bracers.jpg', sourceVideo: 'Craft.mp4', timestamp: '00:10', notes: 'Pieza de equipo Qiongqi mostrada en la lista de Common Craft.' },
        { name: 'Qiongqi Heavy Helmet', category: 'Gear', source: 'Craft', status: 'confirmado', image: 'assets/images/items/qiongqi-heavy-helmet.jpg', sourceVideo: 'Craft.mp4', timestamp: '00:10', notes: 'Pieza de equipo Qiongqi mostrada en la lista de Common Craft.' },
        ...
        { name: 'Trinket Pack - Earth Tier', category: 'Trinket', source: 'Celestial Realm', status: 'confirmado', image: 'assets/images/items/trinket-pack-earth-tier.jpg', sourceVideo: 'Dungeon1.mp4', timestamp: '00:15', notes: 'Proporciona aleatoriamente un Earth Tier Trinket Shard; el tooltip muestra Celestial Realm como método.' },
        { name: 'Trinket Pack - Mystic Tier', category: 'Trinket', source: 'Celestial Realm / Fuse', status: 'confirmado', image: 'assets/images/items/trinket-pack-mystic-tier.jpg', sourceVideo: 'Dungeon1.mp4', timestamp: '00:45', notes: 'Proporciona aleatoriamente un Mystic Tier Trinket; el tooltip muestra Celestial Realm y Fuse.' },
        { name: 'Earth - Ruined Lantern', category: 'Trinket', source: 'Celestial Realm', status: 'confirmado', image: 'assets/images/items/earth-ruined-lantern.jpg', sourceVideo: 'Dungeon1.mp4', timestamp: '00:20', notes: 'Trinket mostrado con descripción y método de obtención Celestial Realm.' },
        { name: 'Resonance Lostsoul', category: 'Trinket', source: 'Celestial Realm', status: 'confirmado', image: 'assets/images/items/resonance-lostsoul.jpg', sourceVideo: 'Dungeon1.mp4', timestamp: '00:40', notes: 'Objeto mostrado con tooltip y método de obtención Celestial Realm.' },
        ...
        { name: 'Accessory Spiritstone', category: 'Material', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/accessory-spiritstone.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material de accesorio con icono propio visible en Boss Store.' },
        { name: 'Pink Gear Spiritstone', category: 'Material', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/pink-gear-spiritstone.jpg', detailImage: 'assets/images/object-details/pink-gear-spiritstone.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material de equipo rosa con icono propio visible en Boss Store.' },
        ...
        { name: 'Orange 1-Star Holyware', category: 'Gear', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/orange-1-star-holyware.jpg', detailImage: 'assets/images/object-details/orange-1-star-holyware.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Pieza Holyware naranja de 1 estrella mostrada con icono propio en la tienda.' },
        { name: '1-Star Awakened Soul', category: 'Material', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/one-star-awakened-soul.jpg', detailImage: 'assets/images/object-details/one-star-awakened-soul.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material de despertar de alma mostrado con icono propio en la tienda.' },
        { name: 'Orange Rune Shard', category: 'Material', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/orange-rune-shard.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Fragmento de runa naranja mostrado con icono propio en la tienda.' },
        { name: 'Mantra Stone', category: 'Material', source: 'Boss Store / Exchange', status: 'confirmado', image: 'assets/images/items/mantra-stone.jpg', sourceVideo: 'Shop no pay.mp4', timestamp: '03:20', notes: 'Material de runa mostrado con icono propio en la tienda.' },
        ...
        { name: 'Bright Moon Hairdress', category: 'Outfit', class: 'Spiritfox', source: 'Outfit → Headdress', status: 'confirmado', image: 'assets/images/items/bright-moon-hairdress.jpg', sourceVideo: 'Outfix Spirit.mp4', timestamp: '00:45', notes: 'Tooltip propio con descripción, estadísticas y adquisición por Event.' },
        ...
        { name: "Heaven's Match Hairdress", category: 'Outfit', class: 'Spiritfox', source: 'Outfit → Headdress', status: 'confirmado', image: 'assets/images/items/heavens-match-hairdress.jpg', sourceVideo: 'Outfix Spirit.mp4', timestamp: '01:15', notes: 'Tooltip propio con descripción, estadísticas y adquisición por Event.' },
