...
(function () {
  ...
  function render() {
    ...
    var customContent = page && window.renderGuidePage ? window.renderGuidePage(page) : null;
    main.innerHTML = page ? (customContent || renderPendingPage(page)) : renderNotFound();
  ...
  window.GuideRouter = { render: render, start: function () {
